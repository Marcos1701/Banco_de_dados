...
INSERT INTO FORNECEDOR  VALUES (DEFAULT,'João Silva','40028922', '12345678');
INSERT INTO FORNECEDOR  VALUES (DEFAULT,'Maria Santos','32230197', '87654321');
INSERT INTO FORNECEDOR  VALUES (DEFAULT,'Pedro Almeida','32240816', '98765432');

-- Tabela CATEGORIA
INSERT INTO CATEGORIA (NOME_CAT) VALUES ('Categoria A');
INSERT INTO CATEGORIA (NOME_CAT) VALUES ('Categoria B');
INSERT INTO CATEGORIA (NOME_CAT) VALUES ('Categoria C');

SELECT * FROM CATEGORIA
DELETE FROM CATEGORIA
DROP TABLE CATEGORIA
-- Tabela PRODUTO
INSERT INTO PRODUTO (NOME_PROD, COD_CATEGORIA, VALOR_UNITARIO, QUANT_ESTOQUE, STATUS) VALUES ('Produto A', 1, 10.50, 100, 'V');
INSERT INTO PRODUTO (NOME_PROD, COD_CATEGORIA, VALOR_UNITARIO, QUANT_ESTOQUE, STATUS) VALUES ('Produto B', 2, 5.99, 50, 'V');
INSERT INTO PRODUTO (NOME_PROD, COD_CATEGORIA, VALOR_UNITARIO, QUANT_ESTOQUE, STATUS) VALUES ('Produto C', 1, 8.75, 75, 'V');

-- Tabela INGREDIENTE
INSERT INTO INGREDIENTE (COD_INGREDIENTE, COD_PRODUTO, QUANTIDADE_NECESSARIA) VALUES (1, 3, 2);
INSERT INTO INGREDIENTE (COD_INGREDIENTE, COD_PRODUTO, QUANTIDADE_NECESSARIA) VALUES (2, 2, 1);
INSERT INTO INGREDIENTE (COD_INGREDIENTE, COD_PRODUTO, QUANTIDADE_NECESSARIA) VALUES (3, 1, 3);

-- Tabela MESA
INSERT INTO MESA (COD_MESA, CAPACIDADE) VALUES (1, 4);
INSERT INTO MESA (COD_MESA, CAPACIDADE) VALUES (2, 6);
INSERT INTO MESA (COD_MESA, CAPACIDADE) VALUES (3, 2);

-- Tabela ATENDENTE
INSERT INTO ATENDENTE (NOME_ATEND) VALUES ('José Alberto');
INSERT INTO ATENDENTE (NOME_ATEND) VALUES ('Carlos Andrade');
INSERT INTO ATENDENTE (NOME_ATEND) VALUES ('Alexandre Santana');

-- Tabela COMPRA
INSERT INTO COMPRA (VALOR_TOTAL_COMPRA, DATA_COMPRA) VALUES (150, '2023-06-10 10:00:00');
INSERT INTO COMPRA (VALOR_TOTAL_COMPRA, DATA_COMPRA) VALUES (250, '2023-06-11 15:30:00');
INSERT INTO COMPRA (VALOR_TOTAL_COMPRA, DATA_COMPRA) VALUES (100, '2023-06-12 09:45:00');

-- Tabela COTACAO_ATUAL
INSERT INTO COTACAO_ATUAL (COD_PRODUTO, COD_FORNECEDOR, PRECO_PRODUTO) VALUES (1, 1, 9.99);
INSERT INTO COTACAO_ATUAL (COD_PRODUTO, COD_FORNECEDOR, PRECO_PRODUTO) VALUES (2, 2, 4.50);
INSERT INTO COTACAO_ATUAL (COD_PRODUTO, COD_FORNECEDOR, PRECO_PRODUTO) VALUES (3, 3, 7.25);

-- Tabela PEDIDO
INSERT INTO PEDIDO (COD_MESA, COD_ATENDENTE, VALOR_TOTAL_PEDIDO, STATUS) VALUES (1, 1, 50.75, 'A');
INSERT INTO PEDIDO (COD_MESA, COD_ATENDENTE, VALOR_TOTAL_PEDIDO, STATUS) VALUES (2, 2, 80.20, 'A');
INSERT INTO PEDIDO (COD_MESA, COD_ATENDENTE, VALOR_TOTAL_PEDIDO, STATUS) VALUES (3, 3, 30.50, 'F');

-- Tabela PRODUTO_PEDIDO
INSERT INTO PRODUTO_PEDIDO (COD_PEDIDO, COD_PRODUTO, QUANTIDADE_ITEMP, VALOR_TOTAL_ITEMP) VALUES (1, 1, 2, 21.00);
INSERT INTO PRODUTO_PEDIDO (COD_PEDIDO, COD_PRODUTO, QUANTIDADE_ITEMP, VALOR_TOTAL_ITEMP) VALUES (1, 2, 1, 5.99);
INSERT INTO PRODUTO_PEDIDO (COD_PEDIDO, COD_PRODUTO, QUANTIDADE_ITEMP, VALOR_TOTAL_ITEMP) VALUES (2, 3, 3, 26.25);

-- Tabela PRODUTO_COMPRA
INSERT INTO PRODUTO_COMPRA (COD_COMPRA, COD_PRODUTO, QUANTIDADE_ITEMC, VALOR_TOTAL_ITEMC) VALUES (1, 1, 10, 99.90);
INSERT INTO PRODUTO_COMPRA (COD_COMPRA, COD_PRODUTO, QUANTIDADE_ITEMC, VALOR_TOTAL_ITEMC) VALUES (2, 2, 5, 22.50);
INSERT INTO PRODUTO_COMPRA (COD_COMPRA, COD_PRODUTO, QUANTIDADE_ITEMC, VALOR_TOTAL_ITEMC) VALUES (3, 3, 8, 58.00);
...
-- GRANT ALL ON 
-- FORNECEDOR, CATEGORIA, PRODUTO, MESA, 
-- ATENDENTE, COMPRA, COTACAO_ATUAL, 
-- PEDIDO,PRODUTO_PEDIDO,PRODUTO_COMPRA TO GERENTE WITH GRANT OPTION;
...
GRANT EXECUTE ON FUNCTION ADICIONA_VALORES(INICIAL_TABLE VARCHAR,PARAMETRO_1 VARCHAR),
ADICIONA_VALORES(NAME_TABLE VARCHAR,COD INT,PARAMETRO_1 INT),
ADICIONA_VALORES(NAME_TABLE VARCHAR,PARAMETRO_1 VARCHAR(100),PARAMETRO_2 varchar(100), PARAMETRO_3 char(8)),
ADICIONA_VALORES(NAME_TABLE VARCHAR, PARAMETRO_1 VARCHAR(50), PARAMETRO_2 INT, PARAMETRO_3 REAL, PARAMETRO_4 INT, PARAMETRO_5 CHAR(1)),
ADICIONA_VALORES(NAME_TABLE VARCHAR, PARAMETRO_1 INT, PARAMETRO_2 INT, PARAMETRO_3 INT),
ADICIONA_VALORES(NAME_TABLE VARCHAR, PARAMETRO_1 REAL),
ADICIONA_VALORES(NAME_TABLE VARCHAR, PARAMETRO_1 INT,PARAMETRO_2 INT, PARAMETRO_3 INT, PARAMETRO_4 REAL),
ADICIONA_VALORES(NAME_TABLE VARCHAR, PARAMETRO_1 INT,PARAMETRO_2 INT, PARAMETRO_3 REAL),
...
CREATE OR REPLACE FUNCTION ADICIONAR_NOVO_ATENDENTE(NOME VARCHAR(50), SENHA VARCHAR(50))
RETURNS VOID AS $$
BEGIN
	IF(NOME = '' OR SENHA = '') THEN
		RAISE EXCEPTION 'OPS, NENHUN CAMPO PODE SER VAZIO!!';
	END IF;
	
	EXECUTE format('CREATE USER %I WITH PASSWORD %L IN GROUP ATENDENTE_G', NOME, SENHA);
-- 	CREATE USER NOME WITH PASSWORD SENHA IN GROUP ATENDENTE_G;
	SELECT ADICIONA_VALORES('ATENDENTE',NOME);
END;
$$
LANGUAGE PLPGSQL;
