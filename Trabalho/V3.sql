...
CREATE OR REPLACE FUNCTION EXCLUIR_VALOR(NOME_TABELA VARCHAR, ID_ELEMENTO INT)
 RETURNS VOID AS $$
 BEGIN


 
 	IF NOME_TABELA ILIKE IN(
		"FORNECEDOR", "CATEGORIA", "PRODUTO",
		"INGREDIENTE", "MESA", "ATENDENTE",
		"COMPRA", "COTACAO_ATUAL", "PEDIDO"
		"PRODUTO_PEDIDO", "PRODUTO_COMPRA") THEN
		EXECUTE "DELETE FROM " || NOME_TABELA || "WHERE ID = " || ID_ELEMENTO;
