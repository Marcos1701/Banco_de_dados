...
CREATE TABLE INGREDIENTE (
  COD_INGREDIENTE INT REFERENCES PRODUTO(COD_PRODUTO) PRIMARY KEY, -- INGREDIENTE É UM PRODUTO QUE NÃO É VENDÁVEL..
...
CREATE TABLE PEDIDO (
  ...
  STATUS CHAR(1), -- F => FECHADO (PAGO), N => NÃO FINALIZADO (AINDA NÃO HOUVE O PAGAMENTO)
...
INSERT INTO CATEGORIA (NOME_CAT) VALUES ('Bebidas');
INSERT INTO CATEGORIA (NOME_CAT) VALUES ('Café da Manhã');
INSERT INTO CATEGORIA (NOME_CAT) VALUES ('Almoço');
INSERT INTO CATEGORIA (NOME_CAT) VALUES ('Janta');
INSERT INTO CATEGORIA (NOME_CAT) VALUES ('Especial da casa');
INSERT INTO CATEGORIA (NOME_CAT) VALUES ('Ingrediente');
...
INSERT INTO PRODUTO (NOME_PROD, COD_CATEGORIA, VALOR_UNITARIO, QUANT_ESTOQUE, STATUS) VALUES ('Massa de Cuzcuz', 6, 0, 10, 'N');
INSERT INTO PRODUTO (NOME_PROD, COD_CATEGORIA, VALOR_UNITARIO, QUANT_ESTOQUE, STATUS) VALUES ('Ovos', 6, 0, 10, 'N');
INSERT INTO PRODUTO (NOME_PROD, COD_CATEGORIA, VALOR_UNITARIO, QUANT_ESTOQUE, STATUS) VALUES ('Cuzcuz com ovo', 2, 8.99, 10, 'V');

SELECT * FROM PRODUTO
INSERT INTO INGREDIENTE VALUES (1,3,1)


INSERT INTO PRODUTO (NOME_PROD, COD_CATEGORIA, VALOR_UNITARIO, QUANT_ESTOQUE, STATUS) VALUES ('Massa de Cuzcuz', 6, 0, 10, 'N');
INSERT INTO PRODUTO (NOME_PROD, COD_CATEGORIA, VALOR_UNITARIO, QUANT_ESTOQUE, STATUS) VALUES ('Refrigerante de 1L', 1, 2.99, 15, 'V');
INSERT INTO PRODUTO (NOME_PROD, COD_CATEGORIA, VALOR_UNITARIO, QUANT_ESTOQUE, STATUS) VALUES ('Tomate', 2, 5.99, 50, 'N');
