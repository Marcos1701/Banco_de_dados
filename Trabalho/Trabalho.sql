...
CREATE TABLE ATENDENTE (
  ATENDENTE_ID INT PRIMARY KEY SERIAL,
  NOME VARCHAR(50)
);

CREATE TABLE PEDIDO (
  PEDIDO_ID INT PRIMARY KEY SERIAL,
  MESA_ID INT,
  ATENDENTE_ID INT,
...
CREATE TABLE CATEGORIA (
  CATEGORIA_ID INT PRIMARY KEY SERIAL,
  NOME VARCHAR(50)
);

CREATE TABLE PRODUTO (
  PRODUTO_ID INT PRIMARY KEY SERIAL,
  NOME VARCHAR(50),
...
CREATE TABLE INGREDIENTE (
  INGREDIENTE_ID INT PRIMARY KEY SERIAL,
  NOME VARCHAR(50),
  PRODUTO_ID INT,
...
CREATE TABLE ITEM_COMPRA (
  ITEM_COMPRA_ID INT PRIMARY KEY SERIAL,
  COMPRA_ID INT,
  PRODUTO_ID INT,
  QUANTIDADE INT,
...
CREATE TABLE COMPRA (
  COMPRA_ID INT PRIMARY KEY SERIAL,
  FORNECEDOR_ID INT,
  VALOR_TOTAL REAL,
  DATA_HORA TIMESTAMP DEFAULT NOW(),
...
CREATE TABLE FORNECEDOR (
  FORNECEDOR_ID INT PRIMARY KEY SERIAL,
...
CREATE TABLE COTACAO_ATUAL (
  COTACAO_ID INT PRIMARY KEY SERIAL,
  FORNECEDOR_ID INT,
  PRODUTO_ID INT,
  PRECO REAL,
  FOREIGN KEY (FORNECEDOR_ID) REFERENCES FORNECEDOR(FORNECEDOR_ID),
...
CREATE FUNCTION ADICIONA_VALORES(INICIAL_TABLE CHAR(3),PARAMETRO_1 VARCHAR(100),
								 PARAMETRO_2 varchar(100) not null, PARAMETRO_3 char(8) not null, 
								 PARAMETRO_4 varchar(4) not null)
RETURNS TEXT as $$
BEGIN
